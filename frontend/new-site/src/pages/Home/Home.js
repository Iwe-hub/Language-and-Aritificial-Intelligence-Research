...
function Home() {
  ...
  <img
    src="/assets/9759685.jpg"
    alt="Content visualization"
    className={`main-image ${isVisible.sectionOne ? "zoom-in" : ""}`}
  />
  <img
    src="/assets/there-are-many-people-working-computers-desert-area-generative-ai.jpg"
    alt="Person"
    className={`person-image ${isVisible.sectionOne ? "slide-in-bottom" : ""}`}
  />
  <img
    src="/assets/29732695_National_costumes_s15.jpg"
    alt="Bottom Left"
    className={`bottom-left-image ${isVisible.sectionOne ? "slide-in-top" : ""}`}
  />
  <img
    src="/assets/410691424_5f29e74a-6567-4cda-ae80-11e56f203eb1.jpg"
    alt="Person"
    className={`bottom-img ${isVisible.sectionOne ? "slide-in-bottom" : ""}`}
  />
</div>
      ...
      >
        <div className="section-six-card">
          <div className={`card-six ${isVisible.sectionSix ? "slide-up" : ""}`}>
            <img src="assets\ajike.jpg" alt="Ajike" />
          ...
          >
            <img
              src="\assets\138714605_10312453.jpg"
              alt="Moyo"
            />
            <div className="card-six-content">
          ...
          >
            <img src="\assets\144670174_425e2da6-5024-4639-8f36-8121fa37fdc1.jpg" alt="Kazeem" />
            <div className="card-six-content">
